...
public interface ProductService {
    ProductDTO addProduct(ProductDTO productDTO, String email) throws CustomError;

    ProductDTO updateProduct(int id, ProductDTO productDTO,String email) throws CustomError;
